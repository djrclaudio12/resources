...
no.addEventListener("click", () => {
  if (count == 2) {
    gif.src = "KD/resources/rusure.gif";// gif credit: https://knowyourmeme.com/photos/2738959-mr-fresh-side-eye-cat
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "Knew it baby 😘";
  yes.innerHTML = '<a href="https://askmyval.com/v/cncKDK93BrXdkMsa87N1">Message for you</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
